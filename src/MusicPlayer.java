...
public class MusicPlayer extends PlaybackListener {
    ...
    //need reference to that we can update the gui in this class
    private MusicPlayerGUI musicPlayerGUI;

    //need way to store song's details, so creating a song class
    ...
    // need to track index of playlist Array List
    private int currentPlaylistIndex;

    //use the JPlayer library to create an AdvancedPlayer obj which will handle playing the music
    ...
    public void playCurrentSong(){
        ...
        try{
            ...
            //start a playback slider thread
    ...
    public void playbackFinished(PlaybackEvent evt) {
        ...
        if(isPaused){
            ...
            // if user pressed next or prev we do not need to execute the rest of the code
